                ...
                Sales Analytics
						...
						<li>
							...
							>
								...
								{/* <span className="hidden md:block px-2 py-0.5 ml-auto text-xs font-medium tracking-wide truncate text-red-500 bg-red-50 rounded-full">
									1.2k
								</span> */}
							</a>
						</li>
						<li className="px-5 hidden md:block">
							<div className="flex flex-row items-center mt-5 h-8">
								<div className="text-sm font-light tracking-wide truncate  text-gray-400 uppercase">
									Settings
								</div>
							</div>
						</li>
